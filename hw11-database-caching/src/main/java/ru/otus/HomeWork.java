...
import ru.otus.cachehw.NonExpiringCache;
...
import ru.otus.crm.service.withCache.CachedDbServiceClient;
import ru.otus.crm.service.withCache.CachedDbServiceManager;
...
public class HomeWork {
    ...
    public static void main(String[] args) {
        ...
        var dbServiceClient = new CachedDbServiceClient(new DbServiceClientImpl(transactionRunner, dataTemplateClient),
                new NonExpiringCache<>());
        ...
        var dbServiceManager = new CachedDbServiceManager(new DbServiceManagerImpl(transactionRunner, dataTemplateManager),
                new NonExpiringCache<>());
